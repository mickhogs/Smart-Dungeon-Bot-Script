...
public class SkeletalHordeBoss implements Condition, Task {

	@Override
	public boolean validate() {
		return Dungeon.getCurrentRoom() != null
				&& Dungeon.getCurrentRoom().getNearestNPC(".*eletal horde") != null
	...
	public void run() {
		...
		NPC boss = Dungeon.getCurrentRoom().getNearestNPC(".*eletal horde");
