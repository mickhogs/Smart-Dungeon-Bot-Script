...
public class IcyBonesBoss implements Condition, Task {

	@Override
	public boolean validate() {
		return Dungeon.getCurrentRoom() != null
				&& Dungeon.getCurrentRoom().getNearestNPC(".*y Bones") != null
	...
	public void run() {
		...
		NPC boss = Dungeon.getCurrentRoom().getNearestNPC(".*y Bones");
