...
public class AsteaFrostwebBoss implements Condition, Task {

	@Override
	public boolean validate() {
		return Dungeon.getCurrentRoom() != null
				&& Dungeon.getCurrentRoom().getNearestNPC(".*ea Frostweb") != null
	...
	public void run() {
		...
		NPC boss = Dungeon.getCurrentRoom().getNearestNPC(".*ea Frostweb");
